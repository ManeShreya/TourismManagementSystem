...
public class Destination extends JFrame implements Runnable{
    ...
    public void run()
    {
        String[] text = new String[]{"JW Marriot Hotel","Madarin Oriental Hotel","Four Seasons Hotel","Raddisson Blue Hotel","Classio hotel","The Bay Club Hotel","Brezze Blow Hotel","The Taj Hotel","Happy Morning Motel","The River View Hotel"};
        try
        {
            for(int i = 0; i< 9;i++)
            {
