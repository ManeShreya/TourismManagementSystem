...
public class ViewHotels extends JFrame implements Runnable{
    ...
    public void run()
    {
        String[] text = new String[]{"JW Marriot Hotel","Madarin Oriental Hotel","Four Seasons Hotel","Raddisson Blue Hotel","Classio hotel","The Bay Club Hotel","Brezze Blow Hotel","The Taj Hotel","Happy Morning Motel","River View Hotel"};
    ...
    ViewHotels()
    {
        ...
        caption.setFont(new Font("Times New Roman",Font.ITALIC,40));
